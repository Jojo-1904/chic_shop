        ...
        if(file){
            ...
            reader.onload = function(){
                ...
                if(imgParent.querySelector('.img-form-costume')){
                    ...
                    img.classList.add('img-fluid', 'img-form-costume');
