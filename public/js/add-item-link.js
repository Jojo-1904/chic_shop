...
const addFormToCollection = (e) => {
        ...
        // On crée un li, qui contiendra le prototype du furmulaire
        const item = document.createElement('li');
        // On ajoute dans l'html de la li l'html du prototype de formulaire des images 
        // contenu dans l'attribut data-prototype de l'ul
        // On remplade les __name__ par le numéro de l'index de la collection (l'attribut data-index de l'ul)
